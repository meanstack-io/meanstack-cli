...
var Auth = function () {
    ...
    installDependencies(function () {
        ...
        addFilesInGulpStrategy(function () {
            runGulp(function () {
                log.success('Your application is ready !!!');
            })
        });
    });
};
...
function addFilesInGulpStrategy(done) {
    ...
    log.success("resources/assets/gulp.assets.js => added dependencies in Gulp strategy.");
